    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          description:
            "Discreet, premium junk removal service across Dubai communities.",
          url: absoluteUrl("/"),
          ...
          <div className="animate-fade md:col-span-6">
            <div className="relative">
              <div className="relative aspect-[4/5] w-full overflow-hidden rounded-3xl md:aspect-[5/6]">
                <img
                  src={heroImg}
                  alt="Marhaba Clearance crew loading furniture outside a Dubai villa at golden hour"
        ...
        <div className="grid gap-12 md:grid-cols-12">
          ...
          <div className="md:col-span-6 md:col-start-7">
            <p className="text-lg leading-relaxed text-foreground/85">
              We started Marhaba Clearance because clearing out a home in Dubai should feel effortless — not stressful. Today we are the quiet team behind hundreds of villa handovers, apartment refreshes and office refits across the city.
            </p>
        ...
        <div className="grid gap-12 md:grid-cols-12">
          <div className="md:col-span-5">
            ...
            <div className="mt-8 aspect-[4/3] w-full overflow-hidden rounded-2xl">
              <img src={skylineImg} alt="Dubai skyline at golden hour" loading="lazy" className="h-full w-full object-cover" />
            </div>
            <Link
              to="/service-areas"
              className="link-underline mt-6 inline-flex items-center gap-1 text-sm font-medium"
