...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Marhaba Clearance — Dubai's discreet clearance team" },
      { name: "description", content: "The story, the values and the people behind Marhaba Clearance. A small, dedicated Dubai team focused on doing one thing well." },
      { property: "og:title", content: "About Marhaba Clearance" },
      { property: "og:description", content: "Meet the Dubai team behind Marhaba Clearance and the values that shape every clear-out." },
      { property: "og:url", content: absoluteUrl("/about") },
      { property: "og:image", content: absoluteUrl(teamImg) },
    ],
  ...
  return (
    <SiteLayout>
      <PageHero
        ...
        subtitle="Marhaba Clearance was founded by a small group of Dubai residents who were tired of clearance work that felt rushed, opaque and impersonal. We built the service we wished existed."
        image={teamImg}
        imageAlt="The Marhaba Clearance crew in uniform beside their truck in Dubai"
      />
        ...
        <div className="grid gap-12 md:grid-cols-12">
          <div className="md:col-span-6">
            <div className="aspect-[4/5] overflow-hidden rounded-3xl">
              <img src={skylineImg} alt="Dubai skyline" loading="lazy" className="h-full w-full object-cover" />
            </div>
          </div>
          <div className="md:col-span-5 md:col-start-8">
            ...
            <div className="mt-8 flex flex-wrap gap-3 border-t border-border pt-8">
              <Link to="/services" className="link-underline inline-flex text-sm font-medium">
                See what we do →
              </Link>
              <Link to="/service-areas" className="link-underline inline-flex text-sm font-medium">
                Where we work →
              </Link>
              <Link to="/contact" className="link-underline inline-flex text-sm font-medium">
                Get in touch →
              </Link>
            </div>
          </div>
