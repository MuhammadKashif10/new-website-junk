...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      { title: "Contact Marhaba Clearance — Book a Dubai Pickup" },
      { name: "description", content: "Call or WhatsApp us to book a Dubai junk removal service. Same-day pickups available across the city — a fixed price back within minutes." },
      { property: "og:title", content: "Contact Marhaba Clearance" },
      { property: "og:description", content: "Get in touch to book your Dubai clearance — call or message us on WhatsApp for a fast, fixed quote." },
        ...
        <div className="grid gap-10 md:grid-cols-12">
          ...
          <div className="md:col-span-6">
            ...
            <div className="mt-6 rounded-3xl border border-border bg-background p-8">
              ...
              <ul className="mt-5 space-y-3 text-sm">
                <li>
                  <Link to="/services" className="link-underline inline-flex items-center gap-1 font-medium">
                    Browse everything we clear <ArrowUpRight aria-hidden className="h-4 w-4" />
                  </Link>
                </li>
                <li>
                  <Link to="/service-areas" className="link-underline inline-flex items-center gap-1 font-medium">
                    Check we cover your community <ArrowUpRight aria-hidden className="h-4 w-4" />
                  </Link>
                </li>
                <li>
                  <Link to="/about" className="link-underline inline-flex items-center gap-1 font-medium">
          ...
          <div className="md:col-span-6">
            ...
            <div className="mt-6 aspect-[4/3] overflow-hidden rounded-3xl border border-border">
              <iframe
                title="Marhaba Clearance base location in Al Quoz, Dubai"
